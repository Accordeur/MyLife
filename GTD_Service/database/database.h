...
inline auto initDB(const std::filesystem::path& path) {
    return sqlite_orm::make_storage(path.string(),
                                    sqlite_orm::make_table("TASK",
                                                           ...
                                                           sqlite_orm::make_column("delete_flag", &TaskTable::delete_flag)),
                                    ...
                                    sqlite_orm::make_table("RECURRENCE",
                                                           ...
                                                           sqlite_orm::make_column("calendar", &RecurrenceTable::calendar),
                                                           sqlite_orm::make_column("of_month", &RecurrenceTable::of_month),
                                                           ...
                                                           sqlite_orm::make_column("end_type", &RecurrenceTable::end_type),
                                                           sqlite_orm::make_column("skip", &RecurrenceTable::skip),
